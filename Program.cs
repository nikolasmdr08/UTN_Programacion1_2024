...
namespace MyGame
{
    ...
    public class AudioPlayer
    {
        ...
        public void Play(double volume = 1.0, bool loop = false)
        {
            _mediaPlayer.Open(new Uri(_filePath, UriKind.Relative));
    ...
    class Program
    {
        ...
        static AudioPlayer _menuMusic;
        static AudioPlayer _gameMusic;
        static AudioPlayer _explosionPlayerSonido;
        static AudioPlayer _explosionEnemySonido;
        ...
        static void Main(string[] args)
        {
            ...
            _backgroundMusicPlayer = new AudioPlayer("assets/348164__djfroyd__laser-one-shot-1.wav");
            _menuMusic = new AudioPlayer("assets/671327__sergequadrado__space-expedition.wav");
            _gameMusic = new AudioPlayer("assets/495389__romariogrande__space-steps.wav");
            _explosionPlayerSonido = new AudioPlayer("assets/394128__morganpurkis__space-explosion.wav");
            _explosionEnemySonido = new AudioPlayer("assets/394128__morganpurkis__space-explosion.wav");
            _menuMusic.Play(volume: 0.5, loop: true);
        ...
        static void CheckInputs()
        {
            ...
            if (_currentState == GameState.Juego)
            {
                ...
                if (Engine.KeyPress(Engine.KEY_Z) || Engine.KeyPress(Engine.KEY_1) || //mantener apretado disparo
                    KeyReleased(Engine.KEY_Z) || KeyReleased(Engine.KEY_1)) //disparo por pulsacion
                {
        ...
        static Level CargarNivel(int level)
        {
            ...
            switch (level)
            {
                case 1:
                    ...
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 300, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 100, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 400, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 600, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 350, offset, enemySpeed, ""));
                    break;
                case 2:
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 200, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 500, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyZigzagImage, "comun", 5, "zigzag", posicionInicialX, 300, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyZigzagImage, "comun", 5, "zigzag", posicionInicialX, 100, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 400, offset, enemySpeed, ""));
                    nivel._waves.Add(GenerarOleada(_enemyZigzagImage, "comun", 5, "zigzag", posicionInicialX, 600, offset, enemySpeed, ""));
                    break;
                case 3:
                    nivel._waves.Add(GenerarOleada(_enemyMinaImage, "comun", 1, "mina", posicionInicialX, 200, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 400, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyMinaImage, "comun", 1, "mina", posicionInicialX, 300, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyZigzagImage, "comun", 5, "zigzag", posicionInicialX, 250, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyMinaImage, "comun", 1, "mina", posicionInicialX, 150, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 600, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyMinaImage, "comun", 1, "mina", posicionInicialX, 500, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyZigzagImage, "comun", 5, "zigzag", posicionInicialX, 200, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyMinaImage, "comun", 1, "mina", posicionInicialX, 600, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyLinealImage, "comun", 5, "lineal", posicionInicialX, 350, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyMinaImage, "comun", 1, "mina", posicionInicialX, 550, offset, enemySpeed, "explosion"));
                    nivel._waves.Add(GenerarOleada(_enemyZigzagImage, "comun", 5, "zigzag", posicionInicialX, 300, offset, enemySpeed, "explosion"));
                    break;
                default:
        ...
        static void HandleContinuousShoot()
        {
            ...
            {
                _backgroundMusicPlayer.Play(volume: 0.5, loop: false);
                PlayerShoot();
        ...
        static void TogglePause()
        {
            if (_currentState == GameState.Juego)
            {
                _currentState = GameState.Pausa;
                _gameMusic.Stop();
            }
            else
            {
                _currentState = GameState.Juego;
                _gameMusic.Play(volume: 0.5, loop: true);
                _menuMusic.Stop();
            }
        ...
        {
            Engine.DrawText("Space Shooter", 300, 200, 255, 255, 255, _fontTitle);
        ...
        static void DrawEndGameScreen()
        {
            ...
            Engine.DrawText($"HI-SCORE: {_hiScore}", 450, 300, 255, 255, 255, _font);
        ...
        static void DrawCreditsScreen()
        {
            ...
            string[] controls = {
                "Controles:", "Arriba: Flecha Arriba", "Abajo: Flecha Abajo",
                "Izquierda: Flecha Izquierda", "Derecha:Flecha Derecha",
                "Disparar / Aceptar: Z", "Volver: X", "Pausa: P"
            };
            DrawTextList(controls, 150, 200);
            ...
            Engine.DrawText("VOLVER", 800, 650, 255, 255, 255, _font);
            _playerPosition = new Vector2(760, 660);
        ...
        static void DrawGameScreen()
        {
            ...
            if (_nivelActual != null)
            {
                ...
                if (oleada != null)
                {
                    //Engine.DrawText($"enemies: { oleada._enemies.Count}", 900, 50, 255, 255, 255, _font); control de cantidad, solo para debug
            ...
            Engine.DrawText($"HI-SCORE: {_hiScore}", 824, 50, 255, 255, 255, _font);
        ...
        {
            _explosionPlayerSonido.Play(volume: 0.5, loop: false);
        ...
        static void DestruirEnemigo(Enemy enemigo)
        {
            ...
            _explosionEnemySonido.Play(volume: 0.5, loop: false);
